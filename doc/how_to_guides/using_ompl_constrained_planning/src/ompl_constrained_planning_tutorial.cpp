...
int main(int argc, char** argv)
{
  ...
  // // Building on the previous constraint, we can make it a line, by also reducing the dimension of the box in the
  // x-direction. moveit_msgs::msg::PositionConstraint line_constraint; line_constraint.header.frame_id =
  // move_group_interface.getPoseReferenceFrame(); line_constraint.link_name =
  // move_group_interface.getEndEffectorLink(); shape_msgs::msg::SolidPrimitive line; line.type =
  // shape_msgs::msg::SolidPrimitive::BOX; line.dimensions = { 0.0005, 0.0005, 1.0 };
  ...
  auto target_pose = get_relative_pose(-0.6, 0.1, 0);
